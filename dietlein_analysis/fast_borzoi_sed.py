...
def main():
	...
	parser.add_option(
		...
		dest="vgpairfile",
		default=None,
		help="Optional file of variant-gene pairs to restrict scoring to. If not provided, all snp-gene overlaps are scored. [Default: %default]",
	)
	parser.add_option(
		"-p",
		dest="processes",
	...
	# Load in vg-pairs to test (None means no filtering: score all snp-gene overlaps)
	vg_pairs = None
	if options.vgpairfile is not None:
